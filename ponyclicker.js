    ...
    if(Game.totalsmiles > 10000) {
      ...
      if(Game.muffins > 10) {
        news.push('Дерпи Хувс чудом спасает пекарню от пожара; приписывает свою отвагу «Силе маффинов».',
          ...
          "Твайлайт Спаркл арестована за магические эксперименты над животными — попытку скрестить мышь и маффин.",
      ...
      if(Game.muffins > 100) {
        ...
        "Дискорд сожрал 40 маффинов, а это аж 4 раза по 10, и это же ужасно!",
          ...
          "Принцесса Кейденс объявляет о начале акции «Free Shipping» при покупке маффинов из Кристальной империи. И подмигивает.",
...
  "вигинтиллион"];
  ...
  var upgradeList = {
    ...
    '62':{id:62, cost:8000000000000, name:"Фаустикорн", desc: "Коронации генерируют +1280000 улыбок в секунду за каждую другую коронацию.", fn:gen_upgradetype1(9, 1280000, 0), cond:defcond },
